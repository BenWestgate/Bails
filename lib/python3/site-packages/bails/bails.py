...
# this allows recovery of n using the lower 2 symbols of the identifier
# because that is scrypt(n,non-derived share data+seed)

# recovering the n allows recovering a multi-sig wallet (which must always skip the first share unless the passphrase is intended to be part of the spending threshold)
